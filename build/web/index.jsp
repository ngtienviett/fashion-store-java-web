                    ...
                    <div class="row align-items-center fill_height">
                        <div class="col">
                            <div class="main_slider_content">
                                ...
                                <div class="red_button shop_now_button"><a href="product">shop now</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 text-right deal_ofthe_week_col">
                            <div class="deal_ofthe_week_content d-flex flex-column align-items-center float-right">
                                ...
                                <div class="red_button deal_ofthe_week_button"><a href="product">shop now</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            <div class="product_slider_container">
                                <div class="owl-carousel owl-theme product_slider">
                                    ...
                                    <!-- Slide 1 -->
                                    <c:forEach var="i" items="${requestScope.bestSeller}">
                                    <div class="owl-item product_slider_item">
                                        <div class="product-item">
                                            <div class="product discount">
                                                <div class="product_image">
                                                    <img src="${i.getImages()}" alt="">
                                                </div>
                                                <div class="favorite favorite_left"></div>
                                                <div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-$20</span></div>
                                                <div class="product_info">
                                                    <h6 class="product_name"><a href="product-detail?productCode=${i.getProductCode()}">${i.getProductName()}</a></h6>
                                                    <div class="product_price">${i.getPrice()}</span></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="red_button add_to_cart_button"><a href="cart?productCode=${i.getProductCode()}">add to cart</a></div>
                                    </div>
                                    </c:forEach>
