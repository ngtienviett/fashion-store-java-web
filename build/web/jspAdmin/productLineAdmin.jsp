<%-- 
    ...
    Created on : Nov 10, 2020, 2:10:54 AM
    Author     : GearVn
--%>
...
<html>
    <head>
        ...
        <title>Ananas Product Line</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="./insert/InsertProductLine.jsp"><button class="btn btn-primary">Add Product Line</button></a></th>
        ...
        <div class="container-fluid" style="padding: 2% 10%;text-align: center;vertical-align: central;text-justify: auto">
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="c" items="${productLineAdmin}">
                <tr>
                    <td>${c.getId()}</td>
                    <td>${c.getProductLineName()}</td>
                    
                    
                    
                    <th>
                        <a href="UpdateProductLine?Id=${c.getId()}"><input type="submit" class="btn btn-info" value="Update"/></a> 
                        <a href="DeleteProductLine?Id=${c.getId()}"><input type="submit" class="btn btn-danger" value="Delete"/></a>
                    </th>
                </tr>
                </c:forEach>
            </table>
