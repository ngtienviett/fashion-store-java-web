<%-- 
    Document   : colorAdmin
    Created on : Nov 10, 2020, 2:09:56 AM
    Author     : GearVn
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="./insert/InsertColor.jsp"><button class="btn btn-primary">Add Color</button></a></th>
        ...
        <div class="container-fluid" style="padding: 2% 10%;text-align: center;vertical-align: central;text-justify: auto">
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="c" items="${colorAdmin}">
                <tr>
                    <td>${c.getId()}</td>
                    <td>${c.getColorName()}</td>
                    <td>${c.getColorCode()}</td>
                    
                    <th>
                        <a href="UpdateColor?Id=${c.getId()}"><input type="submit" class="btn btn-info" value="Update"/></a> 
                        <a href="DeleteColor?Id=${c.getId()}"><input type="submit" class="btn btn-danger" value="Delete"/></a>
                    </th>
                </tr>
                </c:forEach>
            </table>
