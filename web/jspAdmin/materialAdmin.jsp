<%-- 
    Document   : materialAdmin
    Created on : Nov 10, 2020, 2:10:34 AM
    Author     : GearVn
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" style="padding: 10% 10%; padding-bottom: 0%">
            <table class="table">
                <tr>
                    <th><a href="./insert/InsertMaterial.jsp"><button class="btn btn-primary">Add Material</button></a></th>
        ...
        <div class="container-fluid" style="padding: 2% 10%;text-align: center;vertical-align: central;text-justify: auto">
            ...
            <table border="1" cellspacing="10px" class="table">
                ...
                <c:forEach var="c" items="${materialAdmin}">
                <tr>
                    <td>${c.getId()}</td>
                    <td>${c.getMaterialName()}</td>
                    <td>${c.getDescription()}</td>
                    
                    
                    <th>
                        <a href="UpdateMaterial?Id=${c.getId()}"><input type="submit" class="btn btn-info" value="Update"/></a> 
                        <a href="DeleteMaterial?Id=${c.getId()}"><input type="submit" class="btn btn-danger" value="Delete"/></a>
                    </th>
                </tr>
                </c:forEach>
            </table>
