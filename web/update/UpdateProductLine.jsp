<%-- 
    Document   : UpdateProductLine
    Created on : Nov 10, 2020, 9:25:13 AM
    Author     : GearVn
--%>
        ...
        <div class="container" style="padding: 10% 10%;text-align: center;vertical-align: central;text-justify: auto">
            <%
                if (session.getAttribute("productLine") != null) {
                    ProductLine c1 = (ProductLine) session.getAttribute("productLine");
                    ProductLineAdminDAO dao = new ProductLineAdminDAO();
                    ProductLine c = dao.select(c1).get(0);
            %>
            <form action="./UpdateProductLine" method="POST">
                <table class="table container">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="productLineName" value="<%= c.getProductLineName()%>"></td>
                    </tr>
