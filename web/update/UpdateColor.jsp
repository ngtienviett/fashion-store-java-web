<%-- 
    ...
    Created on : Nov 10, 2020, 9:22:30 AM
    Author     : GearVn
--%>
        ...
        <div class="container" style="padding: 10% 10%;text-align: center;vertical-align: central;text-justify: auto">
            <%
                if (session.getAttribute("color") != null) {
                    Color c1 = (Color) session.getAttribute("color");
                    ColorAdminDAO dao = new ColorAdminDAO();
                    Color c = dao.select(c1).get(0);
            %>
            <form action="./UpdateColor" method="POST">
                <table class="table container">
                    ...
                    <tr>
                        <th>Color Name</th>
                        <td><input type="text" name="colorName" value="<%= c.getColorName()%>"></td>
                    </tr>
                    <tr>
                        <th>Color Code</th>
                        <td><input type="text" name="colorCode" value="<%= c.getColorCode()%>"></td>
                    </tr>
                    <tr>
