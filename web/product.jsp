                        ...
                        <div class="sidebar" style="margin-top: 20px">
                            <div class="sidebar_section">
                                ...
                                <ul class="sidebar_categories">
                                    <li><a href="category?categoryId=1">Giày</a></li>
                                    <li><a href="category?categoryId=2">Nửa trên</a></li>
                                    <li><a href="category?categoryId=3">Phụ kiện</a></li>
                                    <li><ul class="sidebar_categories">Collection
                                            <c:forEach var="c" items="${collectionList}">
                                                <li>&emsp;&emsp;<a href="category?collectionId=${c.getId()}">${c.getCollectionName()}</a></li>
                                            </c:forEach>
                                        </ul>
                                    </li>
                                </ul>
                                            ...
                                            <ul class="product_sorting">
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sorting_num">
                                                        <li class="num_sorting_btn"><span><a href="product?numProduct=6">6</a></span></li>
                                                        <li class="num_sorting_btn"><span><a href="product?numProduct=12">12</a></span></li>
                                                        <li class="num_sorting_btn"><span><a href="product?numProduct=24">24</a></span></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                            <div class="pages d-flex flex-row align-items-center">
                                                <div class="page_current">
                                                    ...
                                                    <ul class="page_selection">
                                                        <c:forEach begin="1" end="${numPage}" step="1" var="t">
                                                            <li><a href="product?numProduct=${numProduct}&start=${(t-1)*numProduct}&end=${(t*numProduct > size)?size:(t*numProduct)}"><c:out value="${t}"></c:out></a></li>
                                                            </c:forEach>
                                                    </ul>
                                                </div>
                                                <div class="page_total"><span>of</span> ${numPage}</div>
                                                ...
                                                <div class="product-item">
                                                    <div class="product discount product_filter">
                                                        <div class="product_image">
                                                            <img src="${p.getImages()}" alt="">
                                                        </div>
                                                        <div class="favorite favorite_right"></div>
                                                        <!--<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-$20</span></div>-->
                                                        <div class="product_info">
                                                            <h6 class="product_name"><a href="product-detail?productCode=${p.getProductCode()}">${p.getProductName()}</a></h6>
                                                            <div class="product_price">${p.getPrice()}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="red_button add_to_cart_button"><a href="cart?productCode=${p.getProductCode()}">add to cart</a></div>
                                            </c:forEach>
                                        </div>
