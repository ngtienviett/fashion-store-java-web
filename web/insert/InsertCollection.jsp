<%-- 
    Document   : InsertCollection
    Created on : Nov 10, 2020, 2:18:08 PM
    Author     : GearVn
--%>
            ...
            <form action="../InsertCollection" method="POST">
                <table class="table container">
                    <tr>
                        ...
                        <td><input type="text" name="collectionName" value=""></td>
                    </tr>
                    <tr>
                        <th>Collection Image</th>
                        <td><input type="text" name="collectionImage" value=""></td>
                    </tr>
                    <tr>
