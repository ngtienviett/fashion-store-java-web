                    ...
                    <div class="col">
                        ...
                        <div class="breadcrumbs d-flex flex-row align-items-center">
                            <ul>
                                ...
                                <li class="active"><a href="product-detail?productCode=${product.getProductCode()}"><i class="fa fa-angle-right" aria-hidden="true"></i>${product.getProductName()}</a></li>
                            </ul>
                        </div>
...
<!--							<div class="single_product_thumbnails">
						...
						<div class="col-lg-12 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(${product.getImages()})"></div>
							</div>
						</div>
					</div>
				</div>
...
<!--					<div class="free_delivery d-flex flex-row align-items-center justify-content-center">
					...
					<div class="product_price">${product.getPrice()} VND</div>
...
<!--						<span>Quantity:</span>
						...
						<div class="red_button add_to_cart_button"><a href="cart?productCode=${product.getProductCode()}">add to cart</a></div>
